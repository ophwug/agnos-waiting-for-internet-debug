...
func main() {
	...
	fmt.Fprintln(output, "-----------------------------------")
	fmt.Fprintf(output, "This tool checks what AGNOS/openpilot setup sees when it says \"Waiting for internet\" and can run guarded repairs/workarounds when directed by knowledgeable users.\n\n")
